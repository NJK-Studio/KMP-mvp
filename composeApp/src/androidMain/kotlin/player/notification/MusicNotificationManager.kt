...
class MusicNotificationManager(
    ...
    private fun createMusicNotificationChannel() {
        ...
        nm.createNotificationChannel(musicNotificationChannel)
    }
    ...
    private fun buildMusicNotification(mediaSession: MediaSession) {
        PlayerNotificationManager.Builder(
            ...
            .setSmallIconResourceId(R.drawable.media_session_service_notification_ic_music_note)
            .build()
            .also {
    ...
    fun startMusicNotificationService(service: MediaSessionService, session: MediaSession) {
        buildMusicNotification(session)
    }
